...
#else
// pthread disabled for bare metal
#include <stdatomic.h>
...
inline static void ggml_critical_section_start(void) {
    ...
    while (processing > 0) {
        ...
        // sched_yield(); // TODO: reconsider this. disbaled due to bare metal
...
static void ggml_compute_forward_mul_mat(
    ...
    if (ir010 >= ir011 || ir110 >= ir111) {
        // sched_yield(); //gone because of no threads
        return;
    }
...
#define ggml_thread_create(...) 0
#define ggml_thread_join(...)   0
